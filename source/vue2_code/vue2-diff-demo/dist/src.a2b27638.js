...
function mountFragment(vnode, container, isSVG) {
  ...
  switch (childFlags) {
    ...
    case _flags.ChildrenFlags.NO_CHILDREN:
      // 如果没有子节点，等价于挂载 空片段，会创建一个空的文本节点占位
...
function patchElement(prevVNode, nextVNode, container) {
  ...
  if (prevData) {
    for (var _key in nextData) {
      ...
      if (_prevValue && !nextData.hasOwnProperty(_key)) {
        (0, _patchData.patchData)(el, _key, _prevValue, nextData[_key]);
      }
    }
  }
  ...
  //         const nextValue = nextData[key] // { w: ;h:}

  //         switch(key) {

  //             // 处理办法 .key  setAttribute
...
},{"./flags":"src/flags.js","./patchData":"src/patchData.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var prevVNode = (0, _h.h)('ul', null, [(0, _h.h)('li', {
  key: 'a'
}, 1), (0, _h.h)('li', {
  key: 'b'
}, 2), (0, _h.h)('li', {
...
// 新的 VNode
var nextVNode = (0, _h.h)('ul', null, [(0, _h.h)('li', {
  key: 'c'
}, 3), (0, _h.h)('li', {
  key: 'a'
}, 1), (0, _h.h)('li', {
...
},{"./h.js":"src/h.js","./render.js":"src/render.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
